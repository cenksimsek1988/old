...
import com.softactive.task.TokensPurgeTask;
...
@SpringBootTest(classes = { TestTaskConfig.class })
@Transactional
public class TokenExpirationIntegrationTest {
    ...
    public void whenContextLoad_thenCorrect() {
        ...
        assertNotNull(userRepository.getOne(user_id));

        VerificationToken verificationToken = tokenRepository.getOne(token_id);
    ...
    public void whenPurgeTokenTask_thenCorrect() {
        ...
        assertNull(tokenRepository.getOne(token_id));
    }
}
